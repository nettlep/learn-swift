...
/*:
 ...
 unique function assigned to it's namespace.  The namespace of a type's
 functions just have the name of the class prepended to it. If you went
 and looked at the object files generated by the Swift compiler you
 would find this function amongst the symbols with this name.
 ...
 so that you can see the type of the variable `f` there.
...
```
 This _should_ surprise you in several respects.
...
/*:
 ...
 "Hey! what happened to my closure `{ "\($0)" }`?"  The answer
