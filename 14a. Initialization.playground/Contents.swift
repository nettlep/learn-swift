 ...
 * Swift provides an initializer (which partially resembles a function) to ensure that every
   property in a class, structure or enumeration is fully initialized before the object can
   be used.
...
/*:
 Optional properties do not need to be initialized, because they will by default be initialized to nil.
*/
