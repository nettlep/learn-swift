...
//
// We'll try to convert a string to a numeric value. Since not all strings can be converted to
// an Integer, casting to an Int from a string returns an optional, "Int?". This way
